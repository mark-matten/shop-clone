...
export function TryOnModal({ isOpen, onClose, clerkId, initialItem }: TryOnModalProps) {
  ...
  const reorderOutfit = useMutation(api.storage.reorderOutfit);
          ...
          <div ref={mobileVirtualTryOnRef} className="flex-1 bg-zinc-50 dark:bg-zinc-800/50 overflow-y-auto pb-safe">
            ...
            <div className="px-3 py-2 border-t border-zinc-200 dark:border-zinc-700">
              <ModelSelector
                ...
                setModelSkinTone={setModelSkinTone}
                otherDetails={otherDetails}
                setOtherDetails={setOtherDetails}
                isPaidUser={isPaidUser}
                genericUsedToday={genericUsedToday}
                freeLimit={FREE_DAILY_LIMIT}
                showPhotoManager={showPhotoManager}
                setShowPhotoManager={setShowPhotoManager}
                selectedPhotoId={selectedPhotoId}
                setSelectedPhotoId={setSelectedPhotoId}
                setSelectedPhotoStorageId={setSelectedPhotoStorageId}
